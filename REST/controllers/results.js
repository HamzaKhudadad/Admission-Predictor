module.exports = function(async, Uni, Users){
    return {
        ...
        postResults: function(req, res){
            async.parallel([
                function(callback){
                    ...
                    Uni.find({'$or': [{'country':regex}, {'name': regex}]}, (err, result) => {
                       callback(err, result); 
                    });
                }
            ], (err, results) => {
                ...
                res.render('results', {title: 'StudentCenter - Results', user: req.user, chunks: dataChunk});
            })
        },
        ...
        viewMembers: function(req, res){
            async.parallel([
                ...
                res.render('members', {title: 'StudentCenter - Members', user: req.user, chunks: dataChunk});
            })
        },
