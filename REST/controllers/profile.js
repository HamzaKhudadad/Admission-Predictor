module.exports = function(async, Users, Message, formidable){
    return {
        ...
        getProfilePage: function(req, res){
            async.parallel([
                ...
                res.render('user/profile', {title: 'StudentCenter - Profile', user:req.user, data: result1, chat:result2});
            });
        },
        ...
        overviewPage: function(req, res){
            async.parallel([
                ...
                res.render('user/overview', {title: 'StudentCenter - Overview', user:req.user, data: result1, chat:result2});
            });
        },
